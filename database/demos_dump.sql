...
\restrict BxWbUyAdgtBiodtKxkmVHpn5l7EmgWzWsrrm6XJjyjOFdUa2mLuY16k8R6XI1g5
...
--
-- Name: calibration_settings; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.calibration_settings OWNER TO postgres;

--
-- Name: calibration_settings_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.calibration_settings_id_seq OWNER TO postgres;

--
-- Name: calibration_settings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: calibrations_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.calibrations_id_seq OWNER TO postgres;

--
-- Name: calibrations_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: demographic_margins; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.demographic_margins OWNER TO postgres;

--
-- Name: demographic_margins_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.demographic_margins_id_seq OWNER TO postgres;

--
-- Name: demographic_margins_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: simulation_responses; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.simulation_responses OWNER TO postgres;

--
-- Name: simulation_responses_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.simulation_responses_id_seq OWNER TO postgres;

--
-- Name: simulation_responses_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: survey_uploads; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.survey_uploads OWNER TO postgres;

--
-- Name: survey_uploads_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.survey_uploads_id_seq OWNER TO postgres;

--
-- Name: survey_uploads_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: calibration_settings id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: calibrations id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: demographic_margins id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: simulation_responses id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: survey_uploads id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Data for Name: calibration_settings; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: demographic_margins; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
EVjw6NXENwEDA9xpH2RYeQHIE3wPFcum	{"cookie":{"originalMaxAge":604800000,"expires":"2026-06-25T03:38:28.111Z","secure":false,"httpOnly":true,"path":"/","sameSite":"lax"},"userId":2}	2026-06-25 09:13:36
\.


--
-- Data for Name: simulation_responses; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
15	예산 초과 회귀 테스트	비즈니스	Lumen	테스트	gpt-5	pending	0	500	1.4375	\N	\N	\N	\N	\N	\N	2026-06-18 04:28:27.868142+00	\N	1	\N	\N	\N	\N
16	예산 초과 회귀 테스트	비즈니스	Lumen	테스트	gpt-5	pending	0	500	1.4375	\N	\N	\N	\N	\N	\N	2026-06-18 04:35:53.947001+00	\N	1	\N	\N	\N	\N
\.


--
-- Data for Name: survey_uploads; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
1	test	테스트 사용자	\N	$2b$10$Jn9xW4nldMQupELahVBodevuFQAtmw6Aq13SsN5retYMm8JQuNxDS	user	2026-06-18 00:33:26.079448	3
\.
...
--
-- Name: calibration_settings_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: calibrations_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: demographic_margins_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: simulation_responses_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
SELECT pg_catalog.setval('public.simulations_id_seq', 16, true);


--
-- Name: survey_uploads_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: calibration_settings calibration_settings_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: demographic_margins demographic_margins_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: simulation_responses simulation_responses_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: survey_uploads survey_uploads_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: agents_user_id_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: calibrations_user_id_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: sim_responses_sim_agent_uq; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: simulations_user_id_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: survey_uploads_user_id_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: surveys_user_id_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: agents agents_user_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: calibration_settings calibration_settings_user_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: calibrations calibrations_user_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: simulations simulations_user_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: survey_uploads survey_uploads_user_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: surveys surveys_user_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
\unrestrict BxWbUyAdgtBiodtKxkmVHpn5l7EmgWzWsrrm6XJjyjOFdUa2mLuY16k8R6XI1g5
